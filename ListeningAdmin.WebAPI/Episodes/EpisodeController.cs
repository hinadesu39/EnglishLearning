using ListeningAdmin.WebAPI.Episodes.Request;
...
namespace ListeningAdmin.WebAPI.Episodes
{
    ...
    public class EpisodeController : ControllerBase
    {
        ...
        public EpisodeController(IListeningRepository repository, ListeningDbContext dbContext, EncodingEpisodeHelper encodingEpisodeHelper, IEventBus eventBus, ListeningDomainService domainService)
        {
